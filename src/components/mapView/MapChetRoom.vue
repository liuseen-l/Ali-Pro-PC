...
methods:{
   ...
   * websocket about 
  */
  handleWsOpen(e){ console.log('open')},
  handleWsClose(e){console.log('close',e)},
  handleWsError(e){console.log('error',e) },
  handleWsMessage(e){console.log('message',e)},
...
mounted() {
  ...
  let MsgArrayPush = function fn(val) {
    ...
    if(dateSend.send_user == this.username){
      ant = `<div class="chat_right">
                <div class="chat_right_item">
                    <div class="chat_right_name clearfix">`+ dateSend.send_user + `</div>
                    <span class="chat_right_content clearfix">`+ dateSend.send_content +` </span>
                </div>
              </div>`;
    }else{
      ant = `<div class="chat_left">
                <div class="chat_left_item">
                    <div class="chat_left_name clearfix"> `+ dateSend.send_user +`</div>
                    <span class="chat_left_content clearfix">`+ dateSend.send_content +`</span>
                </div>
              </div>`;
    }
    oLi.innerHTML=ant;
